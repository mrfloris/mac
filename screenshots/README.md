...
## Shell Script Examples and Documentation4
...
And when you're ready to start, feed it the `-ask` parameter, and you can press enter to quickly go through the defaults, or enter a custom value if you want. It will prompt you first to confirm those are the changes you wish to make, control-c can always be used, but a graceful n to discontinue is possible at this stage.  If you select y, for yes, it will attempt to write the values to the plist preference files. And then restart the service. The changes are live, you can use them right away. 
...
### Version
Last updated: November 14th, 2024 - version 1.0.1, build 010.
